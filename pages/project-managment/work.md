...
2. Фасилитация встречи
  ...
  2. Открытие встречи:
     ...
     - Озвучиваем повестку.
     - Озвучиваем тайминг.
  3. Переходим к рассмотрению пунктов повестки
  4. В процессе встречи записываем поручения и решения (их нужно будет занести в реестр поручений и отразить в протоколе совещаний)
