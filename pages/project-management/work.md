...
1. Встречи заносим в производственный календарь.  

2. Напоминаем о встрече в день встречи минимум за 1 час! Ссылку на встречу отправляем заранее: при напоминании или за 5-15 минут перед встречей (написать, "встречаемся в 14:00" или "вcтречаемся через 15 минут")  
...
5. Отправить письмо с протоколом всем участникам встречи в день встречи!  
